...
public class RequestInfo {
    ...
    public void setPlainAccessRequest(final PlainAccessRequest plainAccessRequest) {
    ...
    public RequestInfo(final String apiId, final String ver, final Long ts, final String action, final String did, final String key, final String msgId, final String authToken, final String correlationId, final PlainAccessRequest plainAccessRequest, final User userInfo) {
        this.apiId = apiId;
        this.ver = ver;
        this.ts = ts;
        this.action = action;
    ...
    public String toString() {
        String var10000 = this.getApiId();
        return "RequestInfo(apiId=" + var10000 + ", ver=" + this.getVer() + ", ts=" + this.getTs() + ", action=" + this.getAction() + ", did=" + this.getDid() + ", key=" + this.getKey() + ", msgId=" + this.getMsgId() + ", authToken=" + this.getAuthToken() + ", correlationId=" + this.getCorrelationId() + ", plainAccessRequest=" + this.getPlainAccessRequest() + ", userInfo=" + this.getUserInfo() + ")";
    }
    ...
    public static class RequestInfoBuilder {
        ...
        public RequestInfoBuilder apiId(final String apiId) {
            this.apiId = apiId;
            return this;
        }

        public RequestInfoBuilder ver(final String ver) {
            this.ver = ver;
            return this;
        }

        public RequestInfoBuilder ts(final Long ts) {
            this.ts = ts;
            return this;
        }

        public RequestInfoBuilder action(final String action) {
            this.action = action;
            return this;
        }

        public RequestInfoBuilder did(final String did) {
            this.did = did;
            return this;
        }

        public RequestInfoBuilder key(final String key) {
            this.key = key;
            return this;
        }

        public RequestInfoBuilder msgId(final String msgId) {
            this.msgId = msgId;
            return this;
        }

        public RequestInfoBuilder authToken(final String authToken) {
            this.authToken = authToken;
            return this;
        }

        public RequestInfoBuilder correlationId(final String correlationId) {
            this.correlationId = correlationId;
            return this;
        }

        public RequestInfoBuilder plainAccessRequest(final PlainAccessRequest plainAccessRequest) {
            this.plainAccessRequest = plainAccessRequest;
            return this;
        }

        public RequestInfoBuilder userInfo(final User userInfo) {
            this.userInfo = userInfo;
            return this;
        }
